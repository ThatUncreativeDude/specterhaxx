...
local discordInviteCode = "REPLACE_WITH_INVITE_CODE"
...
-- Set up buttons, sliders, and labels
tabs.main:Button("Automatically Join Discord Server", "Joins our Discord Server automatically.", callbacks.joinDiscordServer)
...
Flux:Notification("specterhaxx is currently in BETA, if you experience any bugs, please report it.", "Alright")
